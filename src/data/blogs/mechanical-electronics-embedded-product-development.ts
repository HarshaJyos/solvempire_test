...
export const mechanicalElectronicsEmbeddedBlog: BlogArticleData = {
  ...
  sections: [
    ...
    },
    {
      ...
      text: "Real-World Architecture: The Freshpod Machine",
    },
    {
      type: "paragraph",
      text: "A prime example of unified physical product development is our work on the Freshpod Automated Helmet Sanitization Machine—a commercial system with over 200 units deployed across India, Nepal, and Sri Lanka.",
    },
    {
      type: "paragraph",
      text: "Freshpod required a robust, public-facing machine capable of completing an automated sanitization cycle within 5 minutes. The system demanded complete electromechanical integration:",
    },
    {
      type: "bullets",
      items: [
        "Mechanical Architecture: An 80+ part stainless-steel CNC-fabricated enclosure (5 ft × 2 ft × 2 ft, 65 kg) housing an internal sanitization chamber, magnetic door locks, and equipment isolation compartments.",
        "Custom ESP32 Master PCB: A unified 12V control board engineered across 5 hardware revisions that handles high-voltage UV lamps, ultrasonic fogger transducers, exhaust blower speed, and magnetic interlocks.",
        "Custom DWIN DGUS Touchscreen HMI: An 8-inch industrial display driven over a custom UART protocol that renders dynamic QR codes for Razorpay UPI payments and guides operators through live cycle timers.",
        "Deterministic C++ Firmware: Deterministic state engine managing the transition from payment authorization to multi-stage sanitization, thermal monitoring, and automatic door unlocking.",
      ],
    },
    {
      type: "quote",
      text: "On Freshpod, having mechanical CAD, PCB layout, and firmware under one roof allowed us to iterate through 5 full hardware revisions and ship 200+ production machines backed by a 10-year support agreement.",
      author: "Lohith Medisetti",
      source: "Co-Founder & COO, SolveMpire",
    },
    {
