...
| **Hanish Jyosyabhatla** | Founder & CEO (`/avatars/hanish.webp`, slug: `hanish-jyosyabhatla`) | End-to-end product engineering, systems architecture, embedded controllers, dynamic UPI payments, cloud telemetry, commercial execution. | **Email**: `support@solvempire.com` |
| **Lohith Medisetti** | Co-Founder & COO (`/lohith.webp`, slug: `lohith-medisetti`) | Industrial automation machinery, factory supply chain, DFM validation, CNC manufacturing, kinematics, machine commissioning, assembly lines. | **Email**: `support@solvempire.com` |
| **Teja Mandapalli** | Co-Founder & Product Lead (`/teja.webp`, slug: `teja-mandapalli`) | Mechanical 3D CAD (Autodesk Fusion 360), DFM sheet metal bending & injection tooling, IP65/IP67 enclosure sealing, industrial ergonomics, HMI UI/UX. | **Email**: `support@solvempire.com` |
| **Pavan Kumar Duggirala** | Product Strategist & Marketing (`/avatars/pavan.jpg`, slug: `pavan-kumar-duggirala`) | Product strategy, technical marketing, client roadmaps, engineering narratives. | **Email**: `support@solvempire.com` |
| **Prasad Duggirala** | AI/ML Engineer (`/avatars/pavan.jpg`, slug: `prasad-duggirala`) | Edge AI, computer vision, sensor fusion, predictive maintenance algorithms. | **Email**: `support@solvempire.com` |
...
## 5. Current 18-Journal Chronological Registry (Reference Baseline)
...
| 18 | `post-018` | `remote-monitoring-for-industrial-machines` | `Aug 04, 2026` | **`true`** | Gayathri Boyapati |

*For Post 19 and onwards, continue with `Aug 06, 2026`, `Aug 08, 2026`, etc., maintaining the strict 2-day gap.*
